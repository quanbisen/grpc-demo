...
func (*UserModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_70b40ae90b672768, []int{0}
}
...
func (m *UserModel) GetUserId() uint64 {
	if m != nil {
		return m.UserId
	}
	return 0
...
func init() {
	proto.RegisterFile("internal/service/pb/userModels.proto", fileDescriptor_70b40ae90b672768)
}

var fileDescriptor_70b40ae90b672768 = []byte{
	...
	0x2f, 0x2d, 0x4e, 0x2d, 0xf2, 0xcd, 0x4f, 0x49, 0xcd, 0x29, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9,
	0x17, 0x62, 0x2a, 0x48, 0x52, 0x8a, 0xe6, 0xe2, 0x0c, 0x85, 0x89, 0x0b, 0x89, 0x71, 0xb1, 0x81,
	0x38, 0x9e, 0x29, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x2c, 0x41, 0x50, 0x9e, 0x90, 0x14, 0x17, 0x07,
	0x88, 0x95, 0x97, 0x98, 0x9b, 0x2a, 0xc1, 0xa4, 0xc0, 0xa8, 0xc1, 0x19, 0x04, 0xe7, 0x83, 0xe4,
	0xfc, 0x32, 0x93, 0xb3, 0xc1, 0x72, 0xcc, 0x10, 0x39, 0x18, 0xdf, 0x49, 0xfb, 0xc4, 0x23, 0x39,
	0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0x9c, 0xf1, 0x58, 0x8e, 0x21, 0x4a, 0x52,
	0x1f, 0xdd, 0x65, 0xd6, 0x50, 0x3a, 0x89, 0x0d, 0xec, 0x28, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x2f, 0xd2, 0x31, 0x8b, 0xbc, 0x00, 0x00, 0x00,
}
...
func (m *UserModel) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Nickname) > 0 {
		...
		i = encodeVarintUserModels(dAtA, i, uint64(len(m.Nickname)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Username) > 0 {
	...
	if m.UserId != 0 {
		i = encodeVarintUserModels(dAtA, i, uint64(m.UserId))
		i--
		dAtA[i] = 0x8
	}
...
func (m *UserModel) Size() (n int) {
	...
	_ = l
	if m.UserId != 0 {
		n += 1 + sovUserModels(uint64(m.UserId))
	}
	l = len(m.Username)
	if l > 0 {
